...
public class PoseTypeAdapter extends RemoteTypeAdapter {
    ...
    public static final String LEGACY_TWIST_3D_TYPE_NAME = "rrlib.localization.Pose<3u, double, rrlib.si_units.SIUnit<1, 0, -1, 0, 0, 0, 0>, rrlib.si_units.SIUnit<0, 0, -1, 0, 0, 0, 0>, rrlib.math.angle.NoWrap>";
