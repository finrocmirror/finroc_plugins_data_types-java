 ...
 *
 * tUncertainPose (2D) Java equivalent
 */
public class UncertainPose2D extends Pose2D {
    ...
    public void copyFrom(Pose2D o) {
        super.copyFrom(o);
        if (o instanceof UncertainPose2D) {
            matrix.copyFrom(((UncertainPose2D) o).matrix);
        } else {
    ...
    public boolean equals(Object other) {
        if (other instanceof UncertainPose2D) {
            UncertainPose2D o = (UncertainPose2D)other;
